...
.overall-status-banner {
  ...
  padding: 2rem;
  background:
    linear-gradient(135deg, rgba(96, 249, 72, 0.14), transparent 42%),
  ...
  &__metric--primary {
    ...
    padding: 1.05rem;
    background:
      linear-gradient(180deg, rgba(96, 249, 72, 0.09), rgba(255, 255, 255, 0.02)),
  ...
  &__metric-bar span {
    display: block;
    height: 100%;
    background: linear-gradient(90deg, #60F948, #a7caf3);
