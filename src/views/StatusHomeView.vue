...
const siteMeta = computed(() => {
  return (
    statusData.value?.site ?? {
      name: "SkinDeck Status",
      description:
        "System status, uptime history, and incident communication for SkinDeck services.",
      websiteUrl: "https://skindeck.com",
      subscribeUrl: "https://github.com/Skindeck/status/issues",
    }
  );
});
</script>
